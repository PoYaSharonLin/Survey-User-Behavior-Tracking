...
module SurveyTracker
  module Routes
    ...
    #   GET  /api/survey/session/:user_id → get session details + share_url
    class Survey < Roda
      ...
      route do |r|
        r.on 'session' do
          ...
          r.on String do |user_id|
            # GET /api/survey/session/:user_id
            r.get do
              case Service::SurveySessions::GetSession.new.call(user_id:)
